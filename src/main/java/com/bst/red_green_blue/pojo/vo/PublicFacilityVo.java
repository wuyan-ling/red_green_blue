...
//    @NotBlank(message = "联系方式不能为空")
    ...
    public PublicFacilityVo(Integer requestAddress, String personNumber, String requestUseTime, String contactWay, String remark) {
    ...
    public PublicFacilityVo setRequestAddress(Integer requestAddress) {
        this.requestAddress = requestAddress;
        return this;
    }
